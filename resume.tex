...
\subtext{\textit{Software Engineer} \hfill Bellevue WA, US}
    \begin{zitemize}
        \item Work on Ads attribution backend
    \end{zitemize}
...
\subtext{\textit{Software Engineer II} \hfill Jersey City VA, US}
    \begin{zitemize}
        \item Design and implement of template rendering micro-service with \textbf{AWS Lambda, API-Gateway, DynamoDB, Node.js, Twig, Puppeteer}
...
\subtext{\textit{Software Engineer Intern} \hfill Beijing, China} 
    \begin{zitemize}
        ...
        \item Aggregated data from monitoring systems for Kubernetes to reduce VM resource redundancies by 20\% with \textbf{InfluxDB, Prometheus, Grafana} \& \textbf{Pandas} (Python)
    \end{zitemize}
\vspace{-0.1cm}
